...
const toastVariants = cva(
  [
    ...
    'overflow-hidden rounded-xl border px-4 py-3 shadow-lg',
  ...
  ],
  {
    variants: {
      variant: {
        ...
        warning: 'border-warning/20 bg-warning-subtle text-foreground',
        destructive: 'border-danger/20 bg-danger-subtle text-foreground',
      },
    },
    defaultVariants: {
      variant: 'default',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-7 shrink-0 items-center justify-center rounded-md border',
      'bg-transparent px-3 text-xs font-medium ring-offset-background transition-colors',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'rounded-md p-1 text-muted-foreground/70 opacity-0 transition-opacity',
