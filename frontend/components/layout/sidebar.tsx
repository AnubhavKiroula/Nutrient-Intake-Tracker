...
export function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
      ...
      {/* Navigation */}
      <nav className="flex-1 overflow-y-auto p-3 thin-scrollbar" aria-label="Main navigation">
                ...
                >
                  <Icon
                    className={cn(
                      ...
                      isActive ? 'text-accent' : 'text-sidebar-foreground/50 group-hover:text-sidebar-foreground'
                    )}
                    aria-hidden="true"
                  />
                  <AnimatePresence initial={false}>
      ...
      {!isMobile && (
        <div className="border-t border-sidebar-border p-3">
          <Button
            variant="ghost"
            size="sm"
            className={cn('w-full text-sidebar-foreground/60 hover:text-sidebar-foreground', collapsed && 'justify-center px-0')}
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 z-sidebar w-64 bg-sidebar border-r border-sidebar-border"
